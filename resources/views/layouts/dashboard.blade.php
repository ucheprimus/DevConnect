...
<!-- Mirrored from metropolitanhost.com/themes/themeforest/html/weedoboard/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Jun 2024 03:48:30 GMT -->
...
<head>
    ...
    <link href="/dash/vendors/iconic-fonts/font-awesome/css/all.min.css" rel="stylesheet">
    <link rel="stylesheet" href="/dash/vendors/iconic-fonts/flat-icons/flaticon.css">
    <link rel="stylesheet" href="/dash/vendors/iconic-fonts/cryptocoins/cryptocoins.css">
    <link rel="stylesheet" href="/dash/vendors/iconic-fonts/cryptocoins/cryptocoins-colors.css">
    <!-- Bootstrap core CSS -->
    ...
    <link href="/dash/assets/css/slick.css" rel="stylesheet">
    <!-- Weedo styles -->
...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
    ...
    @include('includes.dash.leftsidebar')
    <!-- Sidebar Right -->
    ...
    <aside id="ms-quick-bar" class="ms-quick-bar fixed ms-d-block-lg">
        ...
        <div class="ms-quick-bar-content">
            ...
            <div class="ms-quick-bar-header clearfix">
                ...
                <button type="button" class="close ms-toggler" data-target="#ms-quick-bar"
                    data-toggle="hideQuickBar" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
                        ...
                        <div class="ms-chat-header px-3">
                            <div class="ms-chat-user-container media clearfix">
                                <div class="ms-chat-status ms-status-online ms-chat-img mr-3 align-self-center">
                                    <img src="/dash/assets/img/dashboard/rakhan-potik-1.jpg" class="ms-img-round"
                                        alt="people">
                                </div>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active show fade in" id="chats">
                                    <ul class="ms-scrollable ms-quickbar-container">
                                        <li
                                            class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                            <div
                                                class="ms-chat-status ms-status-away ms-has-new-msg ms-chat-img mr-3 align-self-center">
                                                <span class="msg-count">3</span>
                                                <img src="/dash/assets/img/dashboard/rakhan-potik-2.jpg"
                                        ...
                                        <li
                                            ...
                                            <div
                                                ...
                                                <img src="/dash/assets/img/dashboard/rakhan-potik-3.jpg"
                                                    class="ms-img-round" alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                                        ...
                                        <li
                                            ...
                                            <div
                                                ...
                                                <img src="/dash/assets/img/dashboard/rakhan-potik-4.jpg"
                                                    class="ms-img-round" alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                                        ...
                                        <li
                                            ...
                                            <div
                                                ...
                                                <img src="/dash/assets/img/dashboard/rakhan-potik-5.jpg"
                                                    class="ms-img-round" alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                                    ...
                                    <ul class="ms-scrollable ms-quickbar-container">
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            <div class="ms-chat-img mr-3 align-self-center">
                                                <img src="/dash/assets/img/dashboard/rakhan-potik-1.jpg"
                                                    class="ms-img-round" alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                                                ...
                                                <ul class="ms-group-members clearfix mt-3 mb-0">
                                                    <li> <img src="/dash/assets/img/dashboard/rakhan-potik-1.jpg"
                                                            alt="member"> </li>
                                                    <li> <img src="/dash/assets/img/dashboard/rakhan-potik-2.jpg"
                                                            alt="member"> </li>
                                                    <li> <img src="/dash/assets/img/dashboard/rakhan-potik-3.jpg"
                                                            alt="member"> </li>
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            ...
                                            <div class="media-body ms-chat-user-info mt-1">
                                                ...
                                                <ul class="ms-group-members clearfix mt-3 mb-0">
                                                    <li> <img src="/dash/assets/img/dashboard/rakhan-potik-3.jpg"
                                                            alt="member"> </li>
                                                    <li> <img src="/dash/assets/img/dashboard/rakhan-potik-4.jpg"
                                                            alt="member"> </li>
                                                </ul>
                                            </div>
                                        </li>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="contacts">
                                    <ul class="ms-scrollable ms-quickbar-container">
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            <div class="ms-chat-img mr-3 align-self-center">
                                                <img src="/dash/assets/img/dashboard/rakhan-potik-7.jpg"
                                                    class="ms-img-round" alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                                                <h6>Raymart Sandiago</h6> <a href="#" class="ms-chat-time"> <i
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            <div class="ms-chat-img mr-3 align-self-center">
                                                <img src="/dash/assets/img/dashboard/rakhan-potik-8.jpg"
                                                    class="ms-img-round" alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                ...
                <div role="tabpanel" class="tab-pane" id="qa-email">
                    ...
                    <div class="ms-email-container">
                        ...
                        <ul class="ms-scrollable ms-quickbar-container">
                            ...
                            <li class="p-3  media ms-email clearfix">
                                <div class="ms-email-img mr-3 ">
                                    <img src="/dash/assets/img/dashboard/rakhan-potik-2.jpg" class="ms-img-round"
                                        alt="people">
                                </div>
                                <div class="media-body ms-email-details">
                            ...
                            <li class="p-3  media ms-email clearfix">
                                <div class="ms-email-img mr-3 ">
                                    <img src="/dash/assets/img/dashboard/rakhan-potik-3.jpg" class="ms-img-round"
                                        alt="people">
                                </div>
                                <div class="media-body ms-email-details">
                        ...
                        <div class="ms-card ms-qa-card ms-deletable">
                            ...
                            <div class="ms-card-body">
                                ...
                                <ul class="ms-note-members clearfix mb-0">
                                    <li class="ms-deletable"> <img src="/dash/assets/img/dashboard/rakhan-potik-2.jpg"
                                            alt="member"> </li>
                                    <li class="ms-deletable"> <img src="/dash/assets/img/dashboard/rakhan-potik-3.jpg"
                                            alt="member"> </li>
                                </ul>
                            </div>
                            <div class="ms-card-footer clearfix">
                                ...
                                <div class="dropdown float-left">
                                    <a href="#" class="text-disabled" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="dropdown-menu-header">
                                            <h6 class="dropdown-header ms-inline m-0"><span
                                                    class="text-disabled">Share With</span></h6>
                                        </li>
                ...
                <div role="tabpanel" class="tab-pane" id="qa-invite">
                    ...
                    <div class="ms-quickbar-container text-center ms-invite-member">
                        ...
                        <form>
                            ...
                            <div class="ms-form-group">
                                <button type="submit" name="invite-member"
                                    class="btn btn-primary w-100">Invite</button>
                            </div>
                        </form>
                    </div>
    ...
    <script src="/dash/assets/js/jquery-3.3.1.min.js"></script>
    <script src="/dash/assets/js/popper.min.js"></script>
    <script src="/dash/assets/js/bootstrap.min.js"></script>
    <script src="/dash/assets/js/perfect-scrollbar.js"></script>
    <script src="/dash/assets/js/jquery-ui.min.js"></script>
    <!-- Global Required Scripts End -->

    <!-- Page Specific Scripts Start -->
    <script src="/dash/assets/js/moment.js"></script>
    <script src="/dash/assets/js/jquery.webticker.min.js"></script>
    <script src="/dash/assets/js/Chart.bundle.min.js"></script>
    <script src="/dash/assets/js/Chart.Financial.js"></script>
    <script src="/dash/assets/js/table-line.js"></script>
    <script src="/dash/assets/js/index-chart.js"></script>

    <script src="/dash/assets/js/d3.v3.min.js"></script>
    <script src="/dash/assets/js/topojson.v1.min.js"></script>
    <script src="/dash/assets/js/datamaps.all.min.js"></script>
    <script src="/dash/assets/js/index-map.js"></script>

    <!-- Page Specific Scripts End -->

    <!-- Weedo core JavaScript -->
    <script src="/dash/assets/js/framework.js"></script>
...
<!-- Mirrored from metropolitanhost.com/themes/themeforest/html/weedoboard/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Jun 2024 03:49:09 GMT -->
